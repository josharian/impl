...
var (
	...
	flagOutput   = flag.String("o", "", "output filename (default stdout)")
)
...
impl [-dir directory] [-o output.go] <recv> <iface>
...
`[1:])
	...
	if flagOutput != nil && *flagOutput != "-" {
		...
		defer f.Close()
		out = f
		fmt.Fprintln(out, "package x")
		fmt.Fprintln(out, "// Code generated by impl; DO NOT EDIT.")
	}
	fmt.Fprint(out, string(src))
}
